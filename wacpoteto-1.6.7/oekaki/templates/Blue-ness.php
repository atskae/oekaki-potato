...
$t_comment = 'For people that like blue XD';
...
$tInputBackgroundColor = '#0C91C2';

// Buttons
$sButtonHeight          = '20px';
$sButtonFontSize        = '9pt';
$sButtonFontColor       = 'white';
$sButtonBackgroundColor = '#0AAEEA';
$sButtonBorderSize      = '1px';
$sButtonBorderColor     = $mBorderColor;
