...
// Original template written for Oekaki Poteto 5.x by Marcello Bastea-Forte
...
// Main vars
$t_name    = '2draw';
$t_author  = 'Marcello Bastea-Forte';
$t_email   = '[email]marcello@cellosoft.com[/email]';
$t_url     = 'http://2draw.net/';
$t_comment = '...';
...
$tInputHeight          = '21px';
$tInputFontSize        = '10pt';
$tInputFontColor       = 'white';
$tInputBackgroundColor = '#6666FF';

// Buttons
$sButtonHeight          = '20px';
$sButtonFontSize        = '9pt';
$sButtonFontColor       = 'white';
$sButtonBackgroundColor = '#6666FF';
$sButtonBorderSize      = '1px';
$sButtonBorderColor     = '#6666FF';
$sButtonBorderStyle     = 'inset';
